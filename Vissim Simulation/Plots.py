...
total = [df_sim[df_sim['cycle'] == cycle]['TotalCapacity'].values for cycle in cycles_sim]
plt.figure(figsize=(12, 8))
...
# Titles and labels
plt.xlabel('Cycle Length (seconds)', fontsize=18, fontproperties='Times New Roman')
plt.ylabel('Capacity of the Intersection (veh/hr)', fontsize=18, fontproperties='Times New Roman')
# plt.title('Simulation vs. Theoretical Capacity', fontsize=22, fontproperties='Times New Roman', pad=10)
